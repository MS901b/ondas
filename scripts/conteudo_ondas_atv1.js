...
var Questoes = [{ //Parte 1
        ...
        parte1_q3: //Questão 3
        {
            itens: [{ //A
                ...
                msgErro: 'Varie o valor de "c" no quadro ao lado até que as funções coincidam. Note que você também pode usar as setas do teclado para variar o valor no seletor.',
