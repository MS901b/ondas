...
var Questoes = [{ //Parte 1
        parte1_q1: //Questão 1
        {
            itens: [{ //A
                ...
                msgErro: 'Lembre-se que o parâmetro “a” determina a amplitude da função; o parâmetro “b”, o período; e o parâmetro “d” altera a imagem sem modificar a amplitude. Com isso em mente, varie os valores de cada parâmetro no quadro ao lado para fazer com que o gráfico da função tenha as características informadas nos textos acima.'
            }]
        },
        parte1_q2: //Questão 2
        {
